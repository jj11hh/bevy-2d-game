...
use bevy::render::render_resource::{
    AddressMode, AsBindGroup, AsBindGroupError, BindGroupLayout, BindGroupLayoutEntry, BindingType,
    BufferBindingType, BufferInitDescriptor, BufferUsages, FilterMode, OwnedBindingResource,
            ...
            BindGroupLayoutEntry {
                ...
                ty: BindingType::Buffer {
                    ...
                    min_binding_size: Some(
                        NonZeroU64::new(size_of::<TerrainMaterialUniform>() as u64).unwrap(),
                    ),
                },
                count: None,
            },
